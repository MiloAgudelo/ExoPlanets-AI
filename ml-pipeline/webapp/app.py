...
with st.spinner("🔄 Procesando datos..."):
    try:
        # Crear archivo temporal multiplataforma (funciona en Windows, Linux y Mac)
        ...
        try:
            ...
            start_idx = detect_table_start(temp_file_path)
            if start_idx is not None:
                df_pd, df_raw = parse_table_from(temp_file_path, start_idx)
